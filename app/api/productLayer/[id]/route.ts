...
export async function GET(
    ...
    try {
      ...
      return NextResponse.json(
        { error: 'Failed to fetch product layer', details: error instanceof Error ? error.message : String(error) },
        { status: 500 }
      );
    }
  }
...
export async function PUT(
    ...
    try {
        ...
        return NextResponse.json(
            { error: 'Failed to update layer', details: error instanceof Error ? error.message : String(error) },
            { status: 500 }
        );
    }
}
...
export async function DELETE(
    ...
    try {
        ...
        return NextResponse.json(
            { error: 'Failed to delete layer', details: error instanceof Error ? error.message : String(error) },
            { status: 500 }
        );
    }
}
