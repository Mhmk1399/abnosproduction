    ...
    <div className="container mx-auto py-8 px-4">
      ...
      {selectedStep ? (
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
          <h3 className="text-lg font-medium text-blue-800 mb-2">Select a Production Step</h3>
          <p className="text-blue-600">Please select a production step from above to begin working</p>
        </div>
      )}
    </div>
  );
